...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      const res = await fetch("https://pure-harvest.onrender.com/login", {
        method: "POST",
  ...
  const handleOtpLogin = async () => {
    ...
    if (!showOtpInputs) {
      const res = await fetch("https://pure-harvest.onrender.com/send-login-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      const res = await fetch("https://pure-harvest.onrender.com/verify-login-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          phone,
