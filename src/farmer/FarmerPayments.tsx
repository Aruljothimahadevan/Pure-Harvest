...
export default function Payments() {
    ...
    useEffect(() => {
        ...
        if (!farmerId) return;
        fetch(`http://localhost:5000/api/farmer/bank-details/${farmerId}`)
            .then(res => res.json())
            .then(data => {
                setBank(data);
        ...
        // Fetch payments
        fetch(`http://localhost:5000/api/farmer/payments/${farmerId}`)
            .then(res => res.json())
    ...
    const saveBankDetails = async () => {
        ...
        const res = await fetch(`http://localhost:5000/api/farmer/bank-details/${farmerId}`, {
            method: "POST",
            headers: {
